...
chef_server_url          'https://ec2-34-209-100-203.us-west-2.compute.amazonaws.com/organizations/chef'
...
knife[:aws_access_key_id]     = 'AKIAJVE5I5DWHH2AVOBQ'
knife[:aws_secret_access_key] = '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'
knife[:identity_file]         = '/var/lib/jenkins/chef-repo/.chef/new-iac-coe.pem'
knife[:ssh_key_name]          = 'chef'
knife[:ssh_user]              = 'ubuntu'
